...
export const garments: Garment[] = [
  {
    ...
    colors: [
      ...
      { id: "charcoal", name: "Charcoal", swatch: "#2b2b2b" },
      { id: "mustard", name: "Mustard", swatch: "#d4a017" },
      { id: "red", name: "Red", swatch: "#b23a2f" },
      { id: "royal-blue", name: "Royal Blue", swatch: "#1f4e8c" },
      { id: "teal", name: "Teal", swatch: "#1f6f6f" },
      { id: "purple", name: "Purple", swatch: "#4b2e6f" },
      { id: "pink", name: "Pink", swatch: "#d98ba0" },
      { id: "orange", name: "Orange", swatch: "#d9722c" },
      { id: "olive", name: "Olive", swatch: "#6b6b2f" },
      { id: "ice-blue", name: "Ice Blue", swatch: "#a9c6d9" },
      { id: "white", name: "White", swatch: "#f5f5f5" },
      { id: "brown", name: "Brown", swatch: "#4a2f23" },
      { id: "lavender", name: "Lavender", swatch: "#b9a7d9" },
      { id: "mint", name: "Mint", swatch: "#a9d9c1" },
      { id: "coral", name: "Coral", swatch: "#e0765a" },
      { id: "sand", name: "Sand", swatch: "#ded0b0" },
    ],
    sizes: [
